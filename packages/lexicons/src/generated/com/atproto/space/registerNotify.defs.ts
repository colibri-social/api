...
export const $input = /*#__PURE__*/ l.jsonPayload({"space":/*#__PURE__*/ l.string({"format":"space-ref"}),"service":/*#__PURE__*/ l.string()});
...
const main = /*#__PURE__*/ l.procedure($nsid, $params, $input, $output, ["SpaceNotFound","ServiceNotResolvable"]);
