...
export const $input = /*#__PURE__*/ l.jsonPayload({"space":/*#__PURE__*/ l.string({"format":"space-ref"}),"clientAttestation":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.string())});
...
export const $output = /*#__PURE__*/ l.jsonPayload({"credential":/*#__PURE__*/ l.string()});
...
const main = /*#__PURE__*/ l.procedure($nsid, $params, $input, $output, ["SpaceNotFound","SpaceDeleted","UserNotAuthorized","AppNotAuthorized","NotAuthorized","InvalidDelegationToken","InvalidClientAttestation"]);
