...
const $nsid = "social.colibri.community.negateLabel";
...
export const $input = /*#__PURE__*/ l.jsonPayload({"space":/*#__PURE__*/ l.string({"format":"space-ref"}),"subject":/*#__PURE__*/ l.ref<ColibriLabel.Subject>((() => ColibriLabel.subject) as any),"val":/*#__PURE__*/ l.string(),"reason":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.string({"maxLength":512}))});
