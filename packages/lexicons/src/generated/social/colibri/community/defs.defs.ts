...
const $nsid = "social.colibri.community.defs";
...
type CommunityView = { $type?: "social.colibri.community.defs#communityView";
...
type ViewerState = { $type?: "social.colibri.community.defs#viewerState";
...
type CategoryView = { $type?: "social.colibri.community.defs#categoryView";
...
type ChannelView = { $type?: "social.colibri.community.defs#channelView";
   ...
   */
  "type":"social.colibri.channel.text" | "social.colibri.channel.voice" | l.UnknownString;
...
/** A channel as the AppView serves it. The channel's identity is its space. */
const channelView = /*#__PURE__*/ l.typedObject<ChannelView>($nsid, "channelView", /*#__PURE__*/ l.object({"space":/*#__PURE__*/ l.string({"format":"space-ref"}),"type":/*#__PURE__*/ l.string<{"knownValues":["social.colibri.channel.text","social.colibri.channel.voice"]}>(),"name":/*#__PURE__*/ l.string(),"description":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.string()),"category":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.string({"format":"record-key"})),"ownerOnly":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.boolean()),"allowedRoles":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.array(/*#__PURE__*/ l.string({"format":"record-key"}), )),"allowedMembers":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.array(/*#__PURE__*/ l.string({"format":"did"}), )),"linkEmbeds":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.boolean()),"migratedFrom":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.string({"format":"at-uri"})),"viewer":/*#__PURE__*/ l.ref<ChannelViewerState>((() => channelViewerState) as any),"visibleToRoles":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.array(/*#__PURE__*/ l.string({"format":"record-key"}), )),"visibleToMembers":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.array(/*#__PURE__*/ l.string({"format":"did"}), )),"private":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.boolean())}));

export { channelView };

/** The requesting user's access to a channel. */
type ChannelViewerState = { $type?: "social.colibri.community.defs#channelViewerState";
...
/** A role. */
type RoleView = { $type?: "social.colibri.community.defs#roleView";
...
type RoleChannelOverride = { $type?: "social.colibri.community.defs#roleChannelOverride";
...
type MemberView = { $type?: "social.colibri.community.defs#memberView";
...
type ApplicationView = { $type?: "social.colibri.community.defs#applicationView";
...
/** An invitation code. */
type InvitationView = { $type?: "social.colibri.community.defs#invitationView";
...
type ModerationView = { $type?: "social.colibri.community.defs#moderationView";
...
type LabelView = { $type?: "social.colibri.community.defs#labelView";
...
type BannedActorView = { $type?: "social.colibri.community.defs#bannedActorView";
