...
const $nsid = "social.colibri.beta.channel.reorder";
...
export const $input = /*#__PURE__*/ l.jsonPayload({"community":/*#__PURE__*/ l.string({"format":"did"}),"category":/*#__PURE__*/ l.string({"format":"record-key"}),"channels":/*#__PURE__*/ l.array(/*#__PURE__*/ l.string({"format":"record-key"}), )});
...
const main = /*#__PURE__*/ l.procedure($nsid, $params, $input, $output, ["AuthRequired","Forbidden","CommunityNotFound","CategoryNotFound","InvalidRequest","CredentialsUnavailable"]);
