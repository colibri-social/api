...
const $nsid = "social.colibri.beta.channel.delete";
...
export const $input = /*#__PURE__*/ l.jsonPayload({"channel":/*#__PURE__*/ l.string({"format":"space-ref"})});
...
const main = /*#__PURE__*/ l.procedure($nsid, $params, $input, $output, ["AuthRequired","Forbidden","ChannelNotFound","CredentialsUnavailable","PdsUnavailable","UpstreamFailure"]);
