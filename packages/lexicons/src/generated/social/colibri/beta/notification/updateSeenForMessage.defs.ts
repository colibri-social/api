...
const $nsid = "social.colibri.beta.notification.updateSeenForMessage";
...
export const $input = /*#__PURE__*/ l.jsonPayload({"channel":/*#__PURE__*/ l.string({"format":"space-ref"}),"message":/*#__PURE__*/ l.ref<BetaDefs.RecordRef>((() => BetaDefs.recordRef) as any)});
