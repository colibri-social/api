...
const $nsid = "social.colibri.beta.community.leave";
...
const main = /*#__PURE__*/ l.procedure($nsid, $params, $input, $output, ["AuthRequired","CommunityNotFound","MemberNotFound","SoleOwner","CredentialsUnavailable"]);
