...
const $nsid = "social.colibri.beta.community.applyLabel";
...
export const $input = /*#__PURE__*/ l.jsonPayload({"space":/*#__PURE__*/ l.string({"format":"space-ref"}),"subject":/*#__PURE__*/ l.ref<BetaLabel.Subject>((() => BetaLabel.subject) as any),"val":/*#__PURE__*/ l.string<{"maxLength":128,"knownValues":["hidden","spoiler","embeds-suppressed"]}>({"maxLength":128}),"scope":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.array(/*#__PURE__*/ l.string({"format":"uri"}), )),"reason":/*#__PURE__*/ l.optional(/*#__PURE__*/ l.string({"maxLength":512}))});
