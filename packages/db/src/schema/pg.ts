...
export const spaceRepos = pgTable(
	"space_repos",
	{
...
export const spaceCredentials = pgTable("space_credentials", {
...
export const notifyRegistrations = pgTable("notify_registrations", {
	space: text("space").primaryKey(),
...
export const actorSettings = pgTable("actor_settings", {
	did: text("did").primaryKey(),
...
export const communityCredentials = pgTable("community_credentials", {
...
export const bridgeRegistrations = pgTable(
...
export const bridgePairings = pgTable(
	"bridge_pairings",
	{
		code: text("code").primaryKey(),
		bridge: text("bridge").notNull(),
...
export const bridgeRemoteRooms = pgTable(
	"bridge_remote_rooms",
	{
		community: text("community").notNull(),
...
export const bridgeBackfills = pgTable(
	"bridge_backfills",
	{
		community: text("community").notNull(),
		registration: text("registration").notNull(),
